...
urlpatterns = [
    ...
    path('upload/finish/<int:site_id>/', views.finish_upload, name='finish_upload'), # NEW
    ...
    path('qa/decline-report/<int:report_id>/', views.decline_report, name='decline_report'), # NEW
